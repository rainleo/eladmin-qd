  ...
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      <div style="display: inline-block;margin: 0px 2px;">
        <el-button
          v-permission="['ADMIN','TODOLIST_ALL','TODOLIST_CREATE']"
          class="filter-item"
          size="mini"
          type="primary"
          icon="el-icon-plus"
    ...
    <el-table v-loading="loading" :data="data" size="small" style="width: 100%;">
      ...
      <el-table-column v-if="checkPermission(['ADMIN','TODOLIST_ALL','TODOLIST_EDIT','TODOLIST_DELETE'])" label="操作" width="150px" align="center">
        <template slot-scope="scope">
          ...
          <el-popover
            v-permission="['ADMIN','TODOLIST_ALL','TODOLIST_DELETE']"
            :ref="scope.row.id"
            placement="top"
            width="180">
            <p>确定删除本条数据吗？</p>
  ...
  methods: {
    ...
    edit(data) {
      ...
      _this.form = {
        ...
        copyPersonName: data.copyPerson.username,
        assistantPersonName: data.assistantPerson.username,
