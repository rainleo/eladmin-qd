  ...
  <div class="app-container">
    ...
    <div class="head-container">
      ...
      <div style="display: inline-block;margin: 0px 2px;">
        <el-button v-permission="['ADMIN', 'DEPTDETAIL_ALL', 'DEPTDETAIL_CREATE']" class="filter-item" size="mini" type="primary" icon="el-icon-plus" @click="add">新增</el-button>
      </div>
    </div>
    <!--表单组件-->
    ...
    <el-table v-loading="loading" :data="data" size="small" style="width: 100%;">
      ...
      <el-table-column v-if="checkPermission(['ADMIN', 'DEPTDETAIL_ALL', 'DEPTDETAIL_EDIT', 'DEPTDETAIL_DELETE'])" label="操作" width="150px" align="center">
        <template slot-scope="scope">
          ...
          <el-popover v-permission="['ADMIN', 'DEPTDETAIL_ALL', 'DEPTDETAIL_DELETE']" :ref="scope.row.id" placement="top" width="180">
            <p>确定删除本条数据吗？</p>
